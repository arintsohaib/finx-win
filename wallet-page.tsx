...
import { ArrowLeft, Search, Wallet, AlertTriangle, DollarSign, Info, Loader2 } from 'lucide-react';
...
export function WalletPage() {
  ...
  const { user, refreshBalances, isRefreshingBalances, isInitializing } = useAuthStore();
        ...
        <div className="max-w-4xl mx-auto px-4 py-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center gap-3">
              ...
              {(isInitializing || isRefreshingBalances) && (
                <Loader2 className="h-4 w-4 animate-spin text-primary opacity-70" />
              )}
            </div>
          </div>

          <Card className="gradient-card gradient-card">
                          ...
                          >
                            ...
                            <CardContent className="p-4">
                              <div className="flex items-center justify-between">
                                ...
                                <div className="text-right h-[40px] flex flex-col justify-center">
                                  {(isInitializing || (isRefreshingBalances && walletBalance === '0')) ? (
                ...
                <TabsContent value="withdrawal" className="mt-0">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      {/* Balance Breakdown */}
                      <Card className="gradient-card bg-blue-50 dark:bg-blue-950 border-blue-200 dark:border-blue-800">
